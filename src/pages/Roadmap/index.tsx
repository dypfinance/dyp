                    ...
                    <AutoColumn gap="md">
                      <RowBetween>
                        <TYPE.white fontWeight={600}>
                          ...
                          Contract for miners<div></div>➫ Add Liquidity Participating Pools<div></div>➫ Ethereum mining
                          pool Whitelist Launch<div></div>➫ Launch DYP Governace<div></div>➫ Launch DYP Referral
                          <div></div>
                        </TYPE.white>
                      </RowBetween>
                    </AutoColumn>
                ...
                <DataCard>
                  ...
                  <CardSection>
                    <AutoColumn gap="md">
                      <RowBetween>
                        <TYPE.white fontWeight={600}>
                          ➫ Launch New Ethereum mining pool after Ethereum move to PoS<div></div>➫ Built-in insurance
                          for all DYP liquidity providers<div></div>➫ Further extension and project growth in different
                          areas<div></div>
                        </TYPE.white>
                      </RowBetween>
                    </AutoColumn>
