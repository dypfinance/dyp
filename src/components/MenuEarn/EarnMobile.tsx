...
export default function EarnMobile({ isOpen, onDismiss }: { isOpen: boolean; onDismiss: () => void }) {
      ...
      {!attempting && (
        <ContentWrapper gap="lg">
          <ModalUpper>
            ...
            <CardSection gap="md">
              <RowBetween>
                <TYPE.white fontWeight={500}>Earn</TYPE.white>
          ...
          <AutoColumn gap="md" justify={'center'}>
            <MenuItem id={`vote-nav-link`} to={'/vault'}>
              Vault <NewSticker>NEW</NewSticker>
            </MenuItem>
            <MenuItem id={`vote-nav-link`} to={'/farm'}>
              Farm 🔥
            </MenuItem>
            <MenuItem id={`vote-nav-link`} to={'/stake'}>
              Stake 🚜
            </MenuItem>
            <RowBetween />
          </AutoColumn>
